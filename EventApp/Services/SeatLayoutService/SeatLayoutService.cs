...
//        {
//            // Fetch all seats for the layout, ordered by row and column
//            var allSeats = await _context.Seats
//                .Where(s => s.SeatLayoutId == layoutId)
...
//            // Determine distinct rows
//            var distinctRows = allSeats
...
//            // Calculate which rows belong to the requested page
//            var rowsForPage = distinctRows
//                .Skip((pagination.PageNumber - 1) * rowsPerPage)
//                .Take(rowsPerPage)
//                .ToList();

//            // Select seats that belong to those rows
//            var items = allSeats
//                .Where(s => rowsForPage.Contains(s.RowNumber))
//                .ToList();

//            // Compute total pages
//            int totalPages = (int)Math.Ceiling((double)distinctRows.Count / rowsPerPage);

//            return new PagedResult<SeatDto>
//            {
//                Items = items,
//                TotalCount = allSeats.Count,
//                PageNumber = pagination.PageNumber,
//                PageSize = rowsForPage.Count, // number of rows in this page
